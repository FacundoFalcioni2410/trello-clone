...
export function CardPreview({ card, onClick }: { card: Card; onClick: (card: Card) => void }) {
  ...
  return (
    <div
      ...
      className="cursor-pointer rounded-lg bg-[var(--c-card)] shadow-sm hover:shadow-md transition-shadow"
    >
